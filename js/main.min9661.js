!function t(n, e, r) {
    ...
    1: [function(t, n, e) {
        ...
        !function(t) {
            function n() {
                var t = a();
                t !== u && (u = t,
                s.trigger("orientationchange"))
            }
            function e(n, e, r, o) {
                var i = r.type;
                r.type = e,
                t.event.dispatch.call(n, r, o),
                r.type = i
            }
            t.attrFn = t.attrFn || {};
            ...
            t.event.special.taphold = {
                setup: function() {
                    ...
                    i.on(o.startevent, function f(t) {
                        ...
                        i.data("callee3", l),
                        u = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageX : t.pageX,
                        c = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageY : t.pageY
                    })
                },
                remove: function() {
            ...
            t.event.special.doubletap = {
                setup: function() {
                    var n, r, i, a, u = this, c = t(u), f = null, s = !1;
                    c.on(o.startevent, function l(e) {
                        return (!e.which || 1 === e.which) && (c.data("doubletapped", !1),
                        n = e.target,
                        c.data("callee1", l),
                        i = e.originalEvent,
                        f || (f = {
                        ...
                        var l = Date.now()
                          ...
                          , v = l - p;
                        if (window.clearTimeout(r),
                        c.data("callee2", h),
                        v < o.doubletap_int && t(n.target).index() == f.index && v > 100) {
                            c.data("doubletapped", !0),
            ...
            t.event.special.singletap = {
                setup: function() {
                    ...
                    r.on(o.startevent, function c(t) {
                        return (!t.which || 1 === t.which) && (a = Date.now(),
                        i = t.target,
                        r.data("callee1", c),
            ...
            t.event.special.tap = {
                setup: function() {
                    var n, r, i = this, a = t(i), u = !1, c = null, f = {
                        x: 0,
                        y: 0
                    };
                    a.on(o.startevent, function s(t) {
                        return a.data("callee1", s),
                        (!t.which || 1 === t.which) && (u = !0,
                        f.x = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageX : t.pageX,
                        f.y = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageY : t.pageY,
                        n = Date.now(),
                        c = t.target,
                        r = t.originalEvent.targetTouches ? t.originalEvent.targetTouches : [t],
                        !0)
            ...
            t.event.special.swipe = {
                setup: function() {
                    function n(e) {
                        u = t(e.currentTarget),
                        u.data("callee1", n),
                        s.x = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageX : e.pageX,
                        s.y = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageY : e.pageY,
                        l.x = s.x,
                        l.y = s.y,
                        c = !0;
                    ...
                    function e(n) {
                        u = t(n.currentTarget),
                        u.data("callee2", e),
                        l.x = n.originalEvent.targetTouches ? n.originalEvent.targetTouches[0].pageX : n.pageX,
                        l.y = n.originalEvent.targetTouches ? n.originalEvent.targetTouches[0].pageY : n.pageY;
                        var r, a = u.parent().data("xthreshold") ? u.parent().data("xthreshold") : u.data("xthreshold"), h = u.parent().data("ythreshold") ? u.parent().data("ythreshold") : u.data("ythreshold"), p = "undefined" != typeof a && a !== !1 && parseInt(a) ? parseInt(a) : o.swipe_h_threshold, v = "undefined" != typeof h && h !== !1 && parseInt(h) ? parseInt(h) : o.swipe_v_threshold;
                        if (s.y > l.y && s.y - l.y > v && (r = "swipeup"),
                        s.x < l.x && l.x - s.x > p && (r = "swiperight"),
                        s.y < l.y && l.y - s.y > v && (r = "swipedown"),
                        s.x > l.x && s.x - l.x > p && (r = "swipeleft"),
                        void 0 != r && c) {
                            s.x = 0,
                            s.y = 0,
                            l.x = 0,
                    ...
                    function r(n) {
                        ...
                        f) {
                            ...
                            i.position.y > v.position.y && i.position.y - v.position.y > h && (e = "swipeup"),
                            i.position.x < v.position.x && v.position.x - i.position.x > l && (e = "swiperight"),
                            i.position.y < v.position.y && v.position.y - i.position.y > h && (e = "swipedown"),
                            i.position.x > v.position.x && i.position.x - v.position.x > l && (e = "swipeleft");
            ...
            t.event.special.scrollstart = {
                setup: function() {
                    function n(t, n) {
                        r = n,
                        e(a, r ? "scrollstart" : "scrollend", t)
                    }
                    var r, i, a = this, u = t(a);
            ...
            t.event.special.orientationchange = i = {
                setup: function() {
                    return !o.orientation_support && (u = a(),
                    s.on("throttledresize", n),
                    !0)
                },
                teardown: function() {
                    return !o.orientation_support && (s.off("throttledresize", n),
                    !0)
                },
                add: function(t) {
                    var n = t.handler;
            ...
            t.event.special.orientationchange.orientation = a = function() {
                ...
                return t = o.orientation_support ? l[window.orientation] : n && n.clientWidth / n.clientHeight < 1.1,
            ...
            var g, d, _, y = 250, w = function() {
                d = Date.now(),
                _ = d - b,
                _ >= y ? (b = d,
                t(this).trigger("throttledresize")) : (g && window.clearTimeout(g),
                g = window.setTimeout(n, y - _))
            }, b = 0;
            t.each({
    ...
    2: [function(t, n, e) {
        (function(t) {
            (function() {
                function r(t, n) {
                    if (t !== n) {
                        var e = null === t
                          ...
                          , a = n === M
                          , u = n === n;
                        if (t > n && !i || !o || e && !a && u || r && u)
                            return 1;
                        if (t < n && !e || !u || i && !r && o || a && o)
                            return -1
                    }
                    return 0
                }
                ...
                function E(t) {
                    function n(t) {
                        if (_(t) && !Ou(t) && !(t instanceof H)) {
                            if (t instanceof y)
                                return t;
                            if (na.call(t, "__chain__") && na.call(t, "__wrapped__"))
                                return pr(t)
                        }
                        return new y(t)
                    }
                    ...
                    function nt() {
                        ...
                        return t.__actions__ = tn(this.__actions__),
                    ...
                    function Zt(t, n) {
                        for (var e = -1, r = t.length, o = -1, i = n.length, a = Bi(r + i); ++e < r; )
                            a[e] = t[e];
                        for (; ++o < i; )
                            a[e++] = n[o];
                        return a
                    ...
                    function fn(t, n) {
                        for (var e = -1, r = t.length, o = Bi(r); ++e < r; )
                            o[e] = n(t[e], e, t);
                        return o
                    }
                    function sn(t, n) {
                    ...
                    function Ln(t, n, e, r, o, i, a) {
                        ...
                        if (!o) {
                            ...
                            if (v || g)
                                return e(v ? t.value() : t, g ? n.value() : n, r, o, i, a)
                        }
                        if (!p)
                            return !1;
                        i || (i = []),
                    ...
                    function Bn(t, n) {
                        ...
                        function(i) {
                            ...
                            if (i = lr(i),
                            (e || !r) && !(a in i)) {
                                if (i = 1 == t.length ? i : Rn(i, Gn(t, 0, -1)),
                                null == i)
                                    return !1;
                                a = Ir(t),
                                i = lr(i)
                        ...
                        return nn(a || n, function(u, c) {
                            ...
                            _(u))
                                ...
                                var f = t[c]
                                  ...
                                  , l = s === M;
                                l && (s = u),
                                s === M && (!i || c in t) || !l && (s === s ? s === f : f !== f) || (t[c] = s)
                            }
                        }),
                        t
                    }
                    function Un(t, n, e, r, o, i, a) {
                        ...
                        var f = t[e]
                          ...
                          , l = s === M;
                        l && (s = c,
                        He(c) && (Ou(c) || qo(c)) ? s = Ou(f) ? f : He(f) ? tn(f) : [] : Bo(c) || Io(c) ? s = Io(f) ? Go(f) : Bo(f) ? f : {} : l = !1),
                        i.push(c),
                        a.push(s),
                        l ? t[e] = r(s, c, o, i, a) : (s === s ? s !== f : f === f) && (t[e] = s)
                    }
                    function qn(t) {
                        return function(n) {
                            return null == n ? M : n[t]
                    ...
                    function ne(t, n) {
                        for (var e = -1, r = n.length, o = Bi(r); ++e < r; )
                            o[e] = t[n[e]];
                        return o
                    }
                    function ee(t, n, e, r) {
                    ...
                    function ie(t, n, e, r) {
                        ...
                        for (var o = 0, i = t ? t.length : 0, a = n !== n, u = null === n, c = n === M; o < i; ) {
                            ...
                            if (a)
                                ...
                                p = u ? h && l && (r || null != s) : c ? h && (r || l) : null != s && (r ? s <= n : s < n);
                            p ? o = f + 1 : i = f
                        }
                        return Ta(i, ka)
                    }
                    ...
                    function ue(t) {
                        var n = new aa(t.byteLength)
                          , e = new va(n);
                        return e.set(new va(t)),
                        n
                    }
                    function ce(t, n, e) {
                        for (var r = e.length, o = -1, i = xa(t.length - r, 0), a = -1, u = n.length, c = Bi(u + i); ++a < u; )
                            c[a] = n[a];
                        for (; ++o < r; )
                            c[e[o]] = t[o];
                        for (; i--; )
                    ...
                    function fe(t, n, e) {
                        for (var r = -1, o = e.length, i = -1, a = xa(t.length - o, 0), u = -1, c = n.length, f = Bi(a + c); ++i < a; )
                            f[i] = t[i];
                        for (var s = i; ++u < c; )
                            f[s + u] = n[u];
                        for (; ++r < o; )
                    ...
                    function le(t) {
                        return yo(function(n, e) {
                            var r = -1
                              ...
                              , a = o > 2 ? e[2] : M
                              , u = o > 1 ? e[o - 1] : M;
                            for ("function" == typeof i ? (i = ae(i, u, 5),
                            o -= 2) : (i = "function" == typeof u ? u : M,
                            o -= i ? 1 : 0),
                            a && Ze(e[0], e[1], a) && (i = o < 3 ? M : i,
                            o = 1); ++r < o; ) {
                                var c = e[r];
                                c && t(n, c, i)
                            }
                    ...
                    function he(t, n) {
                        return function(e, r) {
                            ...
                            if (!er(o))
                                return t(e, r);
                            for (var i = n ? o : -1, a = lr(e); (n ? i-- : ++i < o) && r(a[i], i, a) !== !1; )
                                ;
                            return e
                        }
                    }
                    ...
                    function de(t) {
                        return function(n) {
                            for (var e = -1, r = Mi(li(n)), o = r.length, i = ""; ++e < o; )
                                i = t(i, r[e], e);
                            return i
                        }
                    }
                    ...
                    function Ee(t) {
                        return function() {
                            ...
                            return function() {
                                var t = arguments
                                  , r = t[0];
                                if (n && 1 == t.length && Ou(r) && r.length >= S)
                                    return n.plant(r).value();
                                for (var o = 0, a = e ? i[o].apply(this, t) : r; ++o < e; )
                                    a = i[o].call(this, a);
                                return a
                            }
                        }
                    ...
                    function Ie(t) {
                        return function(n, e, r) {
                            return "function" == typeof e && r === M || (e = ae(e, r, 3)),
                            t(n, e, ni)
                        }
                    }
                    function $e(t) {
                    ...
                    function Ye(t, n, e, r, o, i, a, u, c, f) {
                        function s() {
                            for (var y = arguments.length, b = y, m = Bi(y); b--; )
                                m[b] = arguments[b];
                            if (r && (m = ce(m, r, o)),
                            i && (m = fe(m, i, a)),
                            v || d) {
                            ...
                            var L = h ? e : this
                              , P = p ? L[t] : t;
                            return u && (m = cr(m, u)),
                            l && c < m.length && (m.length = c),
                            this && this !== en && this instanceof s && (P = _ || _e(t)),
                            P.apply(L, m)
                        }
                        var l = n & C
                          , h = n & $
                    ...
                    function Xe(t, n, e) {
                        ...
                        var o = n - r;
                        return e = null == e ? " " : e + "",
                        _i(e, da(o / e.length)).slice(0, o)
                    }
                    function Ce(t, n, e, r) {
                        function o() {
                            for (var n = -1, u = arguments.length, c = -1, f = r.length, s = Bi(f + u); ++c < f; )
                                s[c] = r[c];
                            for (; u--; )
                                s[c++] = arguments[++n];
                    ...
                    function Le(t, n, e, r, o, i, a, u) {
                        ...
                        n = p[1],
                        u = p[9]),
                        p[9] = null == u ? c ? 0 : t.length : xa(u - f, 0) || 0,
                        n == $)
                            var v = ve(p[0], p[2]);
                        else
                            v = n != Y && n != ($ | Y) || p[4].length ? Ye.apply(M, p) : Ce.apply(M, p);
                        var g = h ? Sa : Ua;
                        return g(v, p)
                    }
                    ...
                    function Se(t, n, e, r, o, i, a) {
                        ...
                        if (!p) {
                            var _ = t.constructor
                              , y = n.constructor;
                            if (_ != y && "constructor"in t && "constructor"in n && !("function" == typeof _ && _ instanceof _ && "function" == typeof y && y instanceof y))
                                return !1
                        }
                        return !0
                    }
                    ...
                    function Qe(t) {
                        ...
                        return n && "string" == typeof t[0] && na.call(t, "index") && (e.index = t.index,
                        e.input = t.input),
                        e
                    }
                    function Ve(t) {
                        var n = t.constructor;
                        return "function" == typeof n && n instanceof n || (n = Qi),
                        new n
                    }
                    function Ge(t, n, e) {
                        var r = t.constructor;
                    ...
                    function tr(t, n) {
                        var e = typeof t;
                        if ("string" == e && Mt.test(t) || "number" == e)
                            return !0;
                        if (Ou(t))
                            return !1;
                        var r = !Et.test(t);
                    ...
                    function or(t, n) {
                        ...
                        if (u) {
                            var c = t[3];
                            t[3] = c ? ce(c, u, n[4]) : tn(u),
                            t[4] = c ? w(t[3], q) : tn(n[4])
                        }
                        return u = n[5],
                        u && (c = t[5],
                        t[5] = c ? fe(c, u, n[6]) : tn(u),
                        t[6] = c ? w(t[5], q) : tn(n[6])),
                        u = n[7],
                        u && (t[7] = tn(u)),
                        r & C && (t[8] = null == t[8] ? n[8] : Ta(t[8], n[8])),
                        null == t[9] && (t[9] = n[9]),
                        t[0] = n[0],
                        t[1] = o,
                        t
                    ...
                    function vr(t, n, e) {
                        ...
                        for (var r = 0, o = t ? t.length : 0, i = -1, a = Bi(da(o / n)); r < o; )
                            a[++i] = Gn(t, r, r += n);
                        return a
                    }
                    function gr(t) {
                    ...
                    function dr(t, n, e) {
                        var r = t ? t.length : 0;
                        return r ? ((e ? Ze(t, n, e) : null == n) && (n = 1),
                        Gn(t, n < 0 ? 0 : n)) : []
                    }
                    function _r(t, n, e) {
                        var r = t ? t.length : 0;
                    ...
                    function br(t, n, e, r) {
                        var o = t ? t.length : 0;
                        return o ? (e && "number" != typeof e && Ze(t, n, e) && (e = 0,
                        r = o),
                        $n(t, n, e, r)) : []
                    }
                    function mr(t) {
                    ...
                    function jr(t, n, e) {
                        var r = t ? t.length : 0;
                        return r ? (e && "number" != typeof e && Ze(t, n, e) && (n = 0,
                        e = r),
                        Gn(t, n, e)) : []
                    }
                    function Yr(t, n, e) {
                    ...
                    function Kr(t, n, e) {
                        var r = Ou(t) ? an : Mn;
                        return e && Ze(t, n, e) && (n = M),
                        "function" == typeof n && e === M || (n = Be(n, e, 3)),
                        r(t, n)
                    }
                    function Hr(t, n, e) {
                        var r = Ou(t) ? cn : An;
                    ...
                    function Zr(t, n, e, r) {
                        ...
                        return er(o) || (t = ai(t),
                        o = t.length),
                        e = "number" != typeof e || r && Ze(n, e, r) ? 0 : e < 0 ? xa(o + e, 0) : e || 0,
                        "string" == typeof t || !Ou(t) && Uo(t) ? e <= o && t.indexOf(n, e) > -1 : !!o && Ue(t, n, e) > -1
                    }
                    function to(t, n, e) {
                        var r = Ou(t) ? fn : Wn;
                        return n = Be(n, e, 3),
                    ...
                    function po(t, n, e) {
                        ...
                        function u() {
                            ...
                            d === !1)
                                ...
                                o ? (f && (f = ua(f)),
                                g = l,
                                s = t.apply(h, c)) : f || (f = ha(a, r))
                            }
                            return o && p ? p = ua(p) : p || n === d || (p = ha(i, n)),
                            e && (o = !0,
                            s = t.apply(h, c)),
                            !o || p || f || (c = h = M),
                            s
                        }
                        var c, f, s, l, h, p, v, g = 0, d = !1, _ = !0;
                        if ("function" != typeof t)
                            throw new Ki(U);
                        if (n = n < 0 ? 0 : +n || 0,
                        e === !0) {
                            ...
                            Ro(e) && (y = !!e.leading,
                            d = "maxWait"in e && xa(+e.maxWait || 0, n),
                    ...
                    function vo(t, n) {
                        ...
                        var e = function() {
                            ...
                            return e.cache = i.set(o, a),
                            a
                        };
                        return e.cache = new vo.Cache,
                        e
                    }
                    function go(t) {
                        if ("function" != typeof t)
                    ...
                    function yo(t, n) {
                        ...
                        function() {
                            for (var e = arguments, r = -1, o = xa(e.length - n, 0), i = Bi(o); ++r < o; )
                                i[r] = e[n + r];
                            switch (n) {
                            case 0:
                    ...
                    function bo(t, n, e) {
                        ...
                        if ("function" != typeof t)
                            throw new Ki(U);
                        return e === !1 ? r = !1 : Ro(e) && (r = "leading"in e ? !!e.leading : r,
                    ...
                    function xo(t, n, e, r) {
                        return n && "boolean" != typeof n && Ze(t, n, e) ? n = !1 : "function" == typeof n && (r = e,
                        e = n,
                        n = !1),
                        "function" == typeof e ? xn(t, n, ae(e, r, 1)) : xn(t, n)
                    }
                    function To(t, n, e) {
                    ...
                    function Do(t, n, e, r) {
                        return e = "function" == typeof e ? ae(e, r, 3) : M,
                        Pn(t, qe(n), e)
                    }
                    function Lo(t) {
                        return So(t) && t != +t
                    ...
                    function Bo(t) {
                        var n;
                        if (!_(t) || ra.call(t) != Z || Io(t) || !na.call(t, "constructor") && (n = t.constructor,
                    ...
                    function ni(t) {
                        ...
                        for (var e = t.constructor, r = -1, o = "function" == typeof e && e.prototype === t, i = Bi(n), a = n > 0; ++r < n; )
                            i[r] = r + "";
                        for (var u in t)
                            a && Je(u, n) || "constructor" == u && (o || !na.call(t, u)) || i.push(u);
                        return i
                    }
                    function ei(t) {
                        t = lr(t);
                    ...
                    function ri(t, n, e) {
                        var r = null == t ? M : t[n];
                        return r === M && (null == t || tr(n, t) || (n = hr(n),
                        t = 1 == n.length ? t : Rn(t, Gn(n, 0, -1)),
                        r = null == t ? M : t[Ir(n)]),
                        r = r === M ? e : r),
                        Co(r) ? r.call(t) : r
                    ...
                    function oi(t, n, e) {
                        ...
                        for (var o = -1, i = n.length, a = i - 1, u = t; null != u && ++o < i; ) {
                            var c = n[o];
                            Ro(u) && (o == a ? u[c] = e : null == u[c] && (u[c] = Je(n[o + 1]) ? [] : {})),
                            u = u[c]
                        }
                        return t
                    }
                    ...
                    function fi(t, n, e) {
                        ...
                        var r = null == t
                          , o = null == n;
                        if (null == e && (o && "boolean" == typeof t ? (e = t,
                    ...
                    function li(t) {
                        return t = u(t),
                        t && t.replace(Dt, h).replace(Ot, "")
                    }
                    function hi(t, n, e) {
                        t = u(t),
                        n += "";
                        var r = t.length;
                        return e = e === M ? r : Ta(e < 0 ? 0 : +e || 0, r),
                        e -= n.length,
                        e >= 0 && t.indexOf(n, e) == e
                    }
                    function pi(t) {
                        return t = u(t),
                        t && bt.test(t) ? t.replace(yt, p) : t
                    }
                    function vi(t) {
                        return t = u(t),
                        t && At.test(t) ? t.replace($t, v) : t || "(?:)"
                    }
                    function gi(t, n, e) {
                        t = u(t),
                        n = +n;
                    ...
                    function di(t, n, e) {
                        return (e ? Ze(t, n, e) : null == n) ? n = 0 : n && (n = +n),
                        t = bi(t),
                        Ma(t, n || (Xt.test(t) ? 16 : 10))
                    }
                    function _i(t, n) {
                        var e = "";
                        if (t = u(t),
                    ...
                    function yi(t, n, e) {
                        return t = u(t),
                        e = null == e ? 0 : Ta(e < 0 ? 0 : +e || 0, t.length),
                        t.lastIndexOf(n, e) == e
                    }
                    function wi(t, e, r) {
                        ...
                        t = u(t),
                        e = _n(yn({}, r || e), o, dn);
                        var i, a, c = _n(yn({}, e.imports), o.imports, dn), f = Su(c), s = ne(c, f), l = 0, h = e.interpolate || Lt, p = "__p += '", v = Vi((e.escape || Lt).source + "|" + h.source + "|" + (h === Tt ? jt : Lt).source + "|" + (e.evaluate || Lt).source + "|$", "g"), d = "//# sourceURL=" + ("sourceURL"in e ? e.sourceURL : "lodash.templateSources[" + ++Bt + "]") + "\n";
                        t.replace(v, function(n, e, r, o, u, c) {
                            return r || (r = o),
                            p += t.slice(l, c).replace(Pt, g),
                            e && (i = !0,
                            p += "' +\n__e(" + e + ") +\n'"),
                            u && (a = !0,
                            p += "';\n" + u + ";\n__p += '"),
                        ...
                        var _ = e.variable;
                        _ || (p = "with (obj) {\n" + p + "\n}\n"),
                        p = (a ? p.replace(vt, "") : p).replace(gt, "$1").replace(dt, "$1;"),
                    ...
                    function bi(t, n, e) {
                        var r = t;
                        return (t = u(t)) ? (e ? Ze(r, n, e) : null == n) ? t.slice(m(t), x(t) + 1) : (n += "",
                        t.slice(c(t, n), f(t, n) + 1)) : t
                    }
                    function mi(t, n, e) {
                        var r = t;
                        return t = u(t),
                        t ? (e ? Ze(r, n, e) : null == n) ? t.slice(m(t)) : t.slice(c(t, n + "")) : t
                    }
                    function xi(t, n, e) {
                        var r = t;
                        return t = u(t),
                        t ? (e ? Ze(r, n, e) : null == n) ? t.slice(0, x(t) + 1) : t.slice(0, f(t, n + "") + 1) : t
                    }
                    function Ti(t, n, e) {
                        e && Ze(t, n, e) && (n = M);
                        var r = D
                        ...
                        if (Fo(i)) {
                            if (t.slice(a).search(i)) {
                                ...
                                for (i.global || (i = Vi(i.source, (Yt.exec(i) || "") + "g")),
                    ...
                    function Di(t, n, e) {
                        ...
                        null == n ? (n = t,
                        t = 0) : n = +n || 0;
                        for (var r = -1, o = xa(da((n - t) / (e || 1)), 0), i = Bi(o); ++r < o; )
                            i[r] = t,
                            t += e;
                        return i
                    }
                    ...
                    function Si(t, n, e) {
                        return e && Ze(t, n, e) && (n = M),
                        n = Be(n, e, 3),
                        1 == n.length ? vn(Ou(t) ? t : sr(t), n) : Zn(t, n)
                    }
                    ...
                    : Xi
                      ...
                      , vu = yo(function(t, n) {
                        if (null == t)
                            return [];
                        var e = n[2];
                        return e && Ze(n[0], n[1], e) && (n.length = 1),
                        Jn(t, kn(n), [])
                    })
                      , gu = Ea || function() {
                      ...
                      , Mu = yo(function(t, n) {
                        if (n = kn(n),
                        "function" != typeof t || !an(n, a))
                            throw new Ki(U);
                        var e = n.length;
                        return yo(function(r) {
                            for (var o = Ta(r.length, e); o--; )
                                r[o] = n[o](r[o]);
                    ...
                    y.prototype = Ra(e.prototype),
                    y.prototype.constructor = y,
                    H.prototype = Ra(e.prototype),
                    H.prototype.constructor = H,
                    zt.prototype["delete"] = Nt,
                    zt.prototype.get = Qt,
                    zt.prototype.has = Vt,
                    zt.prototype.set = Gt,
                    Kt.prototype.push = Jt,
                    vo.Cache = zt,
                    n.after = so,
                    n.ary = lo,
                    n.assign = ju,
                    ...
                    ,
                    n.VERSION = I,
                    nn(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function(t) {
                        n[t].placeholder = n
                    }),
                    ...
                    H.prototype.slice = function(t, n) {
                        t = null == t ? 0 : +t || 0;
                        var e = this;
                        return e.__filtered__ && (t > 0 || n < 0) ? new H(e) : (t < 0 ? e = e.takeRight(-t) : t && (e = e.drop(t)),
                        n !== M && (n = +n || 0,
                    ...
                    Yn(H.prototype, function(t, e) {
                        ...
                        i && (n.prototype[e] = function() {
                            ...
                            if (o && !e)
                                return p ? (a = a.clone(),
                                a.__actions__.push(h),
                                t.call(a)) : i.call(M, this.value())[0];
                            if (!o && s) {
                                a = p ? a : new H(this);
                                var v = t.apply(a, n);
                                return v.__actions__.push(h),
                                new y(v,e)
                            }
                            return this.thru(l)
                        }
                    ...
                    H.prototype.clone = nt,
                    H.prototype.reverse = rt,
                    H.prototype.value = qt,
                    n.prototype.chain = qr,
                    n.prototype.commit = zr,
                    n.prototype.concat = nu,
                    n.prototype.plant = Nr,
                    n.prototype.reverse = Qr,
                    n.prototype.toString = Vr,
                    n.prototype.run = n.prototype.toJSON = n.prototype.valueOf = n.prototype.value = Gr,
                ...
                var M, I = "3.10.1", $ = 1, A = 2, O = 4, k = 8, j = 16, Y = 32, X = 64, C = 128, R = 256, D = 30, L = "...", P = 150, W = 16, S = 200, B = 1, F = 2, U = "Expected a function", q = "__lodash_placeholder__", z = "[object Arguments]", N = "[object Array]", Q = "[object Boolean]", V = "[object Date]", G = "[object Error]", K = "[object Function]", H = "[object Map]", J = "[object Number]", Z = "[object Object]", tt = "[object RegExp]", nt = "[object Set]", et = "[object String]", rt = "[object WeakMap]", ot = "[object ArrayBuffer]", it = "[object Float32Array]", at = "[object Float64Array]", ut = "[object Int8Array]", ct = "[object Int16Array]", ft = "[object Int32Array]", st = "[object Uint8Array]", lt = "[object Uint8ClampedArray]", ht = "[object Uint16Array]", pt = "[object Uint32Array]", vt = /\b__p \+= '';/g, gt = /\b(__p \+=) '' \+/g, dt = /(__e\(.*?\)|\b__t\)) \+\n'';/g, _t = /&(?:amp|lt|gt|quot|#39|#96);/g, yt = /[&<>"'`]/g, wt = RegExp(_t.source), bt = RegExp(yt.source), mt = /<%-([\s\S]+?)%>/g, xt = /<%([\s\S]+?)%>/g, Tt = /<%=([\s\S]+?)%>/g, Et = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/, Mt = /^\w*$/, It = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g, $t = /^[:!,]|[\\^$.*+?()[\]{}|\/]|(^[0-9a-fA-Fnrtuvx])|([\n\r\u2028\u2029])/g, At = RegExp($t.source), Ot = /[\u0300-\u036f\ufe20-\ufe23]/g, kt = /\\(\\)?/g, jt = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, Yt = /\w*$/, Xt = /^0[xX]/, Ct = /^\[object .+?Constructor\]$/, Rt = /^\d+$/, Dt = /[\xc0-\xd6\xd8-\xde\xdf-\xf6\xf8-\xff]/g, Lt = /($^)/, Pt = /['\n\r\u2028\u2029\\]/g, Wt = function() {
                    var t = "[A-Z\\xc0-\\xd6\\xd8-\\xde]"
                      , n = "[a-z\\xdf-\\xf6\\xf8-\\xff]+";
                    return RegExp(t + "+(?=" + t + n + ")|" + t + "?" + n + "|" + t + "+|[0-9]+", "g")
                }(), St = ["Array", "ArrayBuffer", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Math", "Number", "Object", "RegExp", "Set", "String", "_", "clearTimeout", "isFinite", "parseFloat", "parseInt", "setTimeout", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap"], Bt = -1, Ft = {};
                Ft[it] = Ft[at] = Ft[ut] = Ft[ct] = Ft[ft] = Ft[st] = Ft[lt] = Ft[ht] = Ft[pt] = !0,
                Ft[z] = Ft[N] = Ft[ot] = Ft[Q] = Ft[V] = Ft[G] = Ft[K] = Ft[H] = Ft[J] = Ft[Z] = Ft[tt] = Ft[nt] = Ft[et] = Ft[rt] = !1;
                var Ut = {};
                Ut[z] = Ut[N] = Ut[ot] = Ut[Q] = Ut[V] = Ut[it] = Ut[at] = Ut[ut] = Ut[ct] = Ut[ft] = Ut[J] = Ut[Z] = Ut[tt] = Ut[et] = Ut[st] = Ut[lt] = Ut[ht] = Ut[pt] = !0,
                Ut[G] = Ut[K] = Ut[H] = Ut[nt] = Ut[rt] = !1;
                var qt = {
                    "À": "A",
                    "Á": "A",
                    "Â": "A",
                  ...
                  , rn = E();
                "function" == typeof define && "object" == typeof define.amd && define.amd ? (en._ = rn,
                define(function() {
                    return rn
    ...
    3: [function(t, n, e) {
        ...
        var o = t("5")
          , i = function() {
            ...
            this.$aboutClose = $("#about-close"),
            this.$aboutTitle = $("#about h1"),
            this.$aboutDescription = $("#about .description"),
            this.$sharingLink = $('[data-ref="sharing"]'),
            this.$title = $("#main-title"),
            this._aboutVisible = !1,
            this.initEvents()
        };
        i.inherit(Object, {
            initEvents: function() {
                ...
                .bind(this)),
                this.$aboutClose.on("tap", function(t) {
                    this.closeAbout(),
                    t.preventDefault(),
                    t.stopPropagation()
                }
                .bind(this)),
                this.$sharingLink.on("tap", function() {
            ...
            loadDemo: function(t, n, e) {
                this.$ui.hide(),
                this.$viewport.on("load", e),
                this.$viewport.attr("src", "demos/" + t),
                this._currentDemo = n
            },
            onDemoLoaded: function() {
                this.$loadingProgress.css("width", "100%"),
                setTimeout(function() {
            ...
            showAbout: function() {
                this._aboutVisible || (this.$about.addClass("visible"),
                this.$viewport.addClass("blur"),
                this.trigger("showabout"),
                this._aboutVisible = !0)
            },
            closeAbout: function() {
                this._aboutVisible && (this.$about.removeClass("visible"),
                this.$viewport.removeClass("blur"),
                this._aboutVisible = !1,
                setTimeout(function() {
            ...
            animateTitle: function() {
                ...
                if (!t.started) {
                    ...
                    this.$title.html(""),
                    this.$title.css("min-height", e + "px"),
                    this.$title.css("paddingLeft", 0),
                    this.$title.css("paddingRight", 0),
                    this.$title.animate({
                        width: n
                    }, {
                        duration: 1e3,
                        easing: "easeOutQuart",
                        complete: function() {
                            o.$title.css("paddingLeft", r),
                            o.$title.css("paddingRight", r),
                            o._animateLetters(function() {
                                setTimeout(function() {
                                    o.$title.fadeOut(2e3)
                                }, 7e3)
                            })
            ...
            _animateLetters: function(t) {
                ...
                $(n).animate({
                    ...
                    step: function() {
                        n.letterCount = Math.floor(n.letterCount),
                        this.$title.html(n.str.substr(0, n.letterCount + 1))
                    }
                    .bind(this),
                    complete: function() {
                        n.started = !1,
    ...
    5: [function(t, n, e) {
        var r = {
            ...
            off: function(t, n, e) {
                var r, o, i, a, c, f, s, l;
                if (!this._events || !u(this, "off", t, [n, e]))
                    return this;
                if (!t && !n && !e)
                    return this._events = void 0,
                    this;
                for (a = t ? [t] : _.keys(this._events),
                c = 0,
                f = a.length; c < f; c++)
                    if (t = a[c],
                    i = this._events[t]) {
                        ...
                        n || e)
                            ...
                            l = i.length; s < l; s++)
                                o = i[s],
                                (n && n !== o.callback && n !== o.callback._callback || e && e !== o.context) && r.push(o);
            ...
            stopListening: function(t, n, e) {
                ...
                if (!r)
                    return this;
                var o = !n && !e;
                e || "object" != typeof n || (e = this),
                t && ((r = {})[t._listenId] = t);
                for (var i in r)
                    t = r[i],
                    t.off(n, e, this),
                    (o || _.isEmpty(t._events)) && delete this._listeningTo[i];
                return this
            }
        }
          , o = /\s+/
          ...
          , u = function(t, n, e, r) {
            ...
            if ("object" == typeof e) {
                for (var i in e)
                    t[n].apply(t, [i, e[i]].concat(r));
                return !1
            }
            if (o.test(e)) {
                for (var a = e.split(o), u = 0, c = a.length; u < c; u++)
                    t[n].apply(t, [a[u]].concat(r));
                return !1
            }
            return !0
        }
          , c = function(t, n) {
            var e, r = -1, o = t.length, i = n[0], a = n[1], u = n[2];
            switch (n.length) {
            case 0:
                for (; ++r < o; )
                    (e = t[r]).callback.call(e.ctx);
                return;
            case 1:
                for (; ++r < o; )
                    (e = t[r]).callback.call(e.ctx, i);
                return;
            case 2:
                for (; ++r < o; )
                    (e = t[r]).callback.call(e.ctx, i, a);
                return;
            case 3:
                for (; ++r < o; )
                    (e = t[r]).callback.call(e.ctx, i, a, u);
                return;
            default:
                for (; ++r < o; )
                    (e = t[r]).callback.apply(e.ctx, n);
                return
            }
        }
          , f = {
        ...
        r.extend(r.easing, {
            ...
            easeInElastic: function(t, n, e, r, o) {
                ...
                u < Math.abs(r)) {
                    ...
                    var i = a / (2 * Math.PI) * Math.asin(r / u);
            ...
            easeOutBack: function(t, n, e, r, o, i) {
                return void 0 == i && (i = 1.70158),
                r * ((n = n / o - 1) * n * ((i + 1) * n + i) + 1) + e
            },
            easeInOutBack: function(t, n, e, r, o, i) {
                return void 0 == i && (i = 1.70158),
                (n /= o / 2) < 1 ? r / 2 * (n * n * (((i *= 1.525) + 1) * n - i)) + e : r / 2 * ((n -= 2) * n * (((i *= 1.525) + 1) * n + i) + 2) + e
            },
    ...
    7: [function(t, n, e) {
        ...
        t("6"),
        t("1"),
        Function.prototype.inherit = function(t, n) {
            if (!t || !_.isFunction(t))
        ...
        var r, o = t("4"), i = t("3"), a = new i, u = window.location.href, c = u.lastIndexOf("/"), f = u.substring(c + 1);
        a.loadDemo(f, o[f], function() {
            r = document.querySelector("iframe").contentWindow.api,
